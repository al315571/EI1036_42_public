...
function crearTablas() {
    global $pdo;
	$productos="CREATE TABLE IF NOT EXISTS  productos (product_id SERIAL PRIMARY KEY, nombre VARCHAR(50) NOT NULL, imagen VARCHAR(100) NOT NULL, precio float NOT NULL);";
