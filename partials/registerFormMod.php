<main>
	...
	<form class="fom_usuario" action="?action=registro_mod" method="POST">

		<legend>Datos básicos</legend>
		<label for="nombre">name</label>
		<br/>
		<input type="text" name="userName" class="item_requerid" size="50" maxlength="50" 
		 placeholder="Miguel" />
		<br/>
		<label for="nombre">surname</label>
		<br/>
		<input type="text" name="surName" class="item_requerid" size="50" maxlength="50"
		 placeholder="Cervantes" />
		<br/>
		<label for="nombre">address</label>
		<br/>
		<input type="text" name="addressName"  size="50" maxlength="50" 
		...
		<br/>
		<input type="text" name="zip_codeName" size="5" maxlength="5" value="
		 placeholder="12530"/>
		<br/>
